...
const db_uri = "postgres://postgres:pL311012Ugi08@119.29.59.110:5454/testdb"; // 务必配置，业务数据库的连接字符串
const db_log_uri = "postgres://postgres:pL311012Ugi08@119.29.59.110:5454/testdb_log"; // 务必配置，日志数据库的连接字符串
